			...
			<div style = "width:700px; text-align:center; margin: 0 auto;">
				...
				<!-- 이전 -->
					<c:if test="${startPage>1 }">
						<li>
							<a href ="popupreviewlist?currentPage=${startPage-1 }">이전</a>
						</li>
					</c:if>
					...
					<c:forEach var = "pp" begin = "${startPage }" end = "${endPage }" >
						<c:if test="${currentPage==pp }">
							<li class="active" >
         						<a href="popupreviewlist?popup_num=${popup_num}&currentPage=${pp }" style="cursor: pointer; background-color: #BDBDBD; border-color: #BDBDBD;">${pp }</a>
      						</li>
						</c:if>
						...
						<c:if test="${currentPage!=pp }">
							<li>
         						<a href="popupreviewlist?popup_num=${popup_num}&currentPage=${pp }" style="color: black;">${pp }</a>
					...
					<c:if test="${endPage<totalPage }">
						<li>
							<a href = "popupreviewlist?currentPage=${endPage+1 }">다음</a>
						</li>
					</c:if>
				</ul>
			</div>
